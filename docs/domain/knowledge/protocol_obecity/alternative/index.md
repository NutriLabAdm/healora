...
|----|------|--------|------|------|
| ALT_MED | Alternative & Complementary Medicine for Weight Loss (Acupuncture, TCM, Ayurveda, Herbal) | done | acupuncture, electroacupuncture, traditional_chinese_medicine, ayurveda, herbal, moderate_evidence | done_alternative_medicine.md |


## Промпты для презентации

### Для клиента
> **Заголовок:** «Alternative Medicine Index: план действий для улучшения здоровья»
>
> **Теория:**
...
### Для специалиста
> **Заголовок:** «Alternative Medicine Index: клинический протокол ведения»
>
> **Теория:**

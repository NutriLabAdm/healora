# Surgical Protocols Index

| ID | Name | Status | Tags | File |
|----|------|--------|------|------|
| BARI_SX | Bariatric Surgery (RYGB, Sleeve, BPD-DS, SADI-S) | done | bariatric, invasive, high_evidence, definitive | done_bariatric_surgery.md |


## Промпты для презентации

### Для клиента
> **Заголовок:** «Surgical Protocols Index: план действий для улучшения здоровья»
>
> **Теория:**
...
### Для специалиста
> **Заголовок:** «Surgical Protocols Index: клинический протокол ведения»
>
> **Теория:**

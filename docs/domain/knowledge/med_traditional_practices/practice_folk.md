...
### Для клиента
> **Заголовок:** «Практика: Народные практики: план действий для улучшения здоровья»
>
> **Теория:**
...
### Для специалиста
> **Заголовок:** «Практика: Народные практики: клинический протокол ведения»
>
> **Теория:**
...
> - Основные интервенции: ---|----------|---------------|, обусловленные) | однократно или по ритуалу |

...
### Для клиента
> **Заголовок:** «Практика: Нутрициология: план действий для улучшения здоровья»
>
> **Теория:**
...
### Для специалиста
> **Заголовок:** «Практика: Нутрициология: клинический протокол ведения»
>
> **Теория:**
...
> - Основные интервенции: ---|----------|---------------|, часовой recall) | 1 раз в 3 месяца |
